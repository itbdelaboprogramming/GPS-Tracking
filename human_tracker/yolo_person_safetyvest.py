...
# To detect humen from front side
# net = cv2.dnn.readNet("weights/yolov3-tiny.weights", "cfg/yolov3-tiny.cfg")

# To detect human from both front and back side (lower fps)
...
# Loading video
cap = cv2.VideoCapture("videos/vestgirl_Trim.mp4")
