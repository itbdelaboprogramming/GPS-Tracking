...
2. Installing the ekfPkg Package

A. Change to the directory that contains the file setup.py and the subdirectory ekfPkg. 
...
3. Using the ekfPkg Package

The ekfPkg package is on your Python path. To import it into a Python script or session, 
execute:
