...
for idx = 1:numPts
    ...
    %noise_acc = (rand()-0.5)*2 * 0;
    %noise_gyro = (rand()-0.5)*2 * 0;
    ...
    elseif idx > 50 && idx < 65  
        V = 0; psi_1dot = -1.005;  V_1dot=0;
    elseif idx == 65
        V_1dot=9.79/dt;
    elseif idx > 65 && idx < 100
        V = 9.79; psi_1dot = -0.895; V_1dot=0;
    elseif idx == 100
        V_1dot=-9.79/dt;
    elseif idx > 100 && idx < 115
        V = 0; psi_1dot = 1.925;  V_1dot=0;
    elseif idx == 116
        V_1dot=11.05/dt;
