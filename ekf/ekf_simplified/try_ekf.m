...
for idx = 1:135
    ...
    noise_lat = (rand()-0.5)*2/10^5 * 0;     
    noise_lon = (rand()-0.5)*2/10^5 * 0;
    noise_V = (rand()-0.5)*2/10^5 * 0;
    noise_acc = (rand()-0.5)*2/10^5 * 0;
    noise_gyro = (rand()-0.5)*2/10^5 * 0;
    ...
    elseif idx > 65 && idx < 100
        V = 9.9; psi_1dot = 0.90; V_1dot=0;
    elseif idx == 100
        V_1dot=-10/dt;
    elseif idx > 100 && idx < 115
        V = 0; psi_1dot = -1.94;  V_1dot=0;
    elseif idx == 116
        V_1dot=11.05/dt;
    ...
    y = ekf(0,dt,lat,lon,odo_VL+noise_V,odo_VR+noise_V);
    %y(3)
